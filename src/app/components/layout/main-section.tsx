      ...
      <div className=" flex justify-between w-full">
        ...
        <div className=" max-w-[530px] flex flex-col gap-5 self-center">
          ...
          <p className=" text-p-gray">
            I am crafting responsive websites where technologies meet creativity
          </p>

          <button className="animated-button py-2 px-4 text-white border border-normal-purple self-start">
        ...
        <div>
          <div className=" relative">
            <Image src={LinesImage} alt="LinesImage" className=" absolute -z-10 top-20"/>
          </div>
